...
const { LoanForm, updateForm, getPassbook, getAadhar, allLoan, repaymentLoan, pendingLoan, loanDetails, loanReject, loanApproved, loanImo } = require("../controller/LoanController");
